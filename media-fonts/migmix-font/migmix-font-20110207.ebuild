...
SRC_URI="
	mirror://sourceforge.jp/mix-mplus-ipa/${MY_PN}-1P-${PV}.zip
	mirror://sourceforge.jp/mix-mplus-ipa/${MY_PN}-2P-${PV}.zip
	mirror://sourceforge.jp/mix-mplus-ipa/${MY_PN}-1M-${PV}.zip
	mirror://sourceforge.jp/mix-mplus-ipa/${MY_PN}-2M-${PV}.zip
"
